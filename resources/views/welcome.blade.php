...
<body>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="header_top_wrap d-flex justify-content-between align-items-center">
                                <div class="text_wrap">
                                    <p><span>+223 82 79 12 34</span> <span>support@donitech.online</span></p>
                                </div>
                                <div class="text_wrap">
                                    <p><a href="https://www.donitech.ml"> <i class="ti-user"></i>  Se connecter</a> <a href="#">S'inscrire</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="header_right d-flex align-items-center">
                                    ...
                                    <div class="Appointment">
                                        <div class="book_btn d-none d-lg-block">
                                            <a data-scroll-nav='1' href="https://www.donitech.ml">Commencer les révisions</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="slider_text ">
                                <h3>Réussir son examen<br>
                                    en apprennant plus<br>
                                    intelligemment.</h3>
                    ...
                    <div class="col-lg-8">
                        <div class="coures_info">
                            <div class="section_title white_text">
                                <h3>Doni Tech</h3>
                                <p>550 exercices, corrigés et anciens sujets d'examen du Mali disponibles <br> tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim <br> veniam, quis nostrud exercitation.</p>
                            </div>
                            <div class="coures_wrap d-flex">
                                <div class="single_wrap">
                                    ...
                                    <h4>Bachelor of <br>
                                        BAC</h4>
                                        <p>Nous proposons une gamme de matières couvrant les domaines les plus important pour les examens BAC.</p>
                                        <a href="#" class="boxed-btn5">S'inscrire maintenant</a>
                                </div>
                                <div class="single_wrap">
                                    <div class="icon">
                                        <i class="flaticon-lab"></i>
                                    ...
                                    <h4>Bachelor of <br>
                                        DEF</h4>
                                        <p>Les mathématiques,la Physique-Chimie, l'histoire, la géographie et la langue française.</p>
                                        <a href="#" class="boxed-btn5">S'inscrire maintenant</a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-md-10">
                    <div class="section_title text-center mb-70">
                        <h3 class="mb-45">"Dernières nouvelles et mises à jour</h3>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <div class="single_event d-flex align-items-center">
                        ...
                        <div class="event_info">
                            <a href="event_details.html">
                                <h4>Grève des écoles privées du Mali : Le mot d’ordre suspendu</h4>
                             </a>
                    ...
                    <div class="single_event d-flex align-items-center">
                        ...
                        <div class="event_info">
                            <a href="event_details.html">
                                <h4>Le BIE de l’UNESCO forme des Cadres du Ministère de l’Education Nationale: Pour améliorer la qualité de l’éducation au Mali !</h4>
                             </a>
                            <p><span> <i class="flaticon-clock"></i> 10:30 pm</span> <span> <i class="flaticon-calendar"></i> 21Nov 2020 </span> <span> <i class="flaticon-placeholder"></i> AH Oditoriam</span> </p>
                        </div>
                    </div>
                    <div class="single_event d-flex align-items-center">
                        ...
                        <div class="event_info">
                            <a href="event_details.html">
                                <h4>Institut Universitaire de Gestion : La grève illimitée déclenchée depuis le 11 février 2023 se poursuit</h4>
                             </a>
                            <p><span> <i class="flaticon-clock"></i> 10:30 pm</span> <span> <i class="flaticon-calendar"></i> 21Nov 2020 </span> <span> <i class="flaticon-placeholder"></i> AH Oditoriam</span> </p>
                        </div>
                    </div>
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="ti-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" >donitech</a>
